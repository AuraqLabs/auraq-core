 ...
 * Original source: https://github.com/shuding/cobe/blob/main/src/shader.frag
 * License: MIT
 *
 * GLSLX_SOURCE_MAIN  — the full minified fragment shader string
 * GLSLX_NAME_*       — minified uniform name constants, used by index.js
 *                      to map human-readable option keys to shader uniforms
 */
...
export const GLSLX_NAME_MARKERS          = "u";
export const GLSLX_NAME_U_RESOLUTION     = "w";
...
export const GLSLX_NAME_SCALE            = "B";
export const GLSLX_NAME_MARKERS_NUM      = "C";
export const GLSLX_NAME_DOTS_BRIGHTNESS  = "D";
export const GLSLX_NAME_DIFFUSE          = "E";
export const GLSLX_NAME_DARK             = "F";
export const GLSLX_NAME_MAP_BASE_BRIGHTNESS = "G";
export const GLSLX_NAME_U_TEXTURE        = "H";
export const GLSLX_NAME_BASE_COLOR       = "S";
export const GLSLX_NAME_MARKER_COLOR     = "T";
export const GLSLX_NAME_OPACITY          = "U";
